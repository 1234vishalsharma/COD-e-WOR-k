...
void student::getdata()
{
     ...
     cin >> sci_marks;
     cout << "\nEnter marks in 2nd language(Hindi):  ";
     cin >> lang2_marks;
...
void create_student()
{
     student stud;
     ofstream oFile;
     oFile.open("student.docx", ios::binary | ios::app);
     stud.getdata();
...
void display_all()
{
     student stud;
     ifstream inFile;
     inFile.open("student.docx", ios::binary);
     if (!inFile)
     {
...
void display_sp(int n)
{
     student stud;
     ifstream iFile;
     iFile.open("student.docx", ios::binary);
     if (!iFile)
     {
          cout << "File could not be opened... Press any Key to exit";
          cin.ignore();
...
void change_student(int n)
{
     ...
     student stud;
     fstream fl;
     fl.open("student.docx", ios::binary | ios::in | ios::out);
     if (!fl)
     {
          cout << "File could not be opened. Press any Key to exit...";
          cin.ignore();
